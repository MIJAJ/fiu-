import { withArtWorksPage } from '@features/artworks/withArtWorks'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          <div className="text-center pb-12 md:pb-16">
            <h1 className="text-7xl font-extrabold leading-tighter tracking-tighter mb-4 inline-block">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-red-400 to-purple-800">
                Arts </span>
              works</h1>
          </div>
        </div>
