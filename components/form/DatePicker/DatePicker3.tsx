...
import { DatepickerCtx, useDatepickerCtx } from "./withDatePicker3";
        ...
        <Reference>
          {({ ref }) => (
            <div className="flex" ref={ref}>
              <input className="w-full border-2 border-gray-300 rounded p-2"
                type="text"
                style={inputStyle}
                ...
                readOnly
              />
              <span className="bg-gray-300 rounded-r flex items-center justify-center text-sm font-semibold text-gray-700 px-2 focus:outline-none"
